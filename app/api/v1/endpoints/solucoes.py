...
async def submeter_solucao(
    ...
    try:
        ...
        # Atualizar pontos do usuário se aprovado
...
def get_solucao(
    ...
    # 🔥 CORREÇÃO: Usar u.nome ao invés de u.nome_completo e e.nome ao invés de e.nome_empresa
    query = """
    SELECT 
        s.*,
        p.titulo as problema_titulo,
...
def solucoes_do_problema(
    ...
    # 🔥 CORREÇÃO: Usar u.nome ao invés de u.nome_completo
    query = """
    SELECT 
        s.*,
        u.nome,
